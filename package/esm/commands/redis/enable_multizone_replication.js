...
export const enableMultizoneReplicationCmd = new Command()
    ...
    .example("Enable", `upstash redis enable-multizone-replication f860e7e2-27b8-4166-90d5-ea41e90b4809`)
    ...
    console.log(cliffy.colors.brightGreen("Multizone replication has been enabled"));
});
